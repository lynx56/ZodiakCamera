...
class Api {
    ...
    func changeSettings(_ param: String, value: String, handler: @escaping (Result<Settings, Error>) -> Void) {
    ...
    func userManipulate(_ command: String, cancelPrevious: Bool = false, handler: @escaping (Result<Void, Error>) -> Void) {
